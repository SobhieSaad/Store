       ...
       // OleDbDataAdapter dataAdapter3;
        ...
        private string processReceivedMessage(string recMess)
        {
          ...
          //  returnedstring = o_c + "\n" + s.ToString();
            ...
            ////////////////////////////////
            if (recMess.Contains("title"))

            {
                if (title == null || added==false || i<=0)
                { returnedstring = "noev"; }
                else
                {
        ...
        {
            connect.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\Lectures\5th year\Graduation Project\New folder\6\TestBTinCsharp\TestBTinCsharp\bin\Debug\Database3.accdb";
         //   connect.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=D:\my project\trydb\TestBTinCsharp\TestBTinCsharp\bin\Debug\Database3.accdb";
            connect.Open();
